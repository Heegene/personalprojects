...
<script type="text/javascript">
	...
	function getBoardDetailCallback(obj) {
		...
		if (obj != null) {
			...
			str += "<tr>";
			str += "<th> 내용 </th>";
			str += "<td colspan='3'> <pre>" + content + "</pre> </td>";
			str += "</tr>";
			...
			<div class="inner">
				...
				<form id="boardForm" name="boardForm">
					...
					<input type="hidden" id="seq" name="seq" value="${seq}" /> <input
						type="hidden" id="search_type" name="search_type" value="S" />
				...
				<div class="btn_right mt15">
					...
					<button type="button" class="btn black mr5"
						onclick="javascript:goBoardUpdate();">글 수정</button>
					<button type="button" class="btn black mr5"
						onclick="javascript:deleteBoard();">글 삭제</button>
